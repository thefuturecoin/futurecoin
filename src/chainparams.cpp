...
public:
    CMainParams() {
        ...
        nSubsidyHalvingInterval = 43829 * 12; //every year

        // Build the genesis block. Note that the output of the genesis coinbase cannot
        // be spent as it did not originally exist in the database.
  
        const char* pszTimestamp = "2014-04-18 FT - Malaysia Airlines Plane still missing";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nTime    = 1397855815;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 697591;
        ...
        assert(hashGenesisBlock == uint256("0x00000799f385d017bdd3c7f41b241f0da3d81f0efbbe1c261cbb3773ea0925f7"));
        assert(genesis.hashMerkleRoot == uint256("0xd420fedc0437b0de8d5a433ebb1649488ddeaac22635c1ad92f96b6ccec4a13c"));


	vSeeds.push_back(CDNSSeedData("seed1.thefuturecoin.org", "seed1.thefuturecoin.org"));
	vSeeds.push_back(CDNSSeedData("seed2.thefuturecoin.org", "seed2.thefuturecoin.org"));
	vSeeds.push_back(CDNSSeedData("seed3.thefuturecoin.org", "seed3.thefuturecoin.org"));
	vSeeds.push_back(CDNSSeedData("seed4.thefuturecoin.org", "seed4.thefuturecoin.org"));

        base58Prefixes[PUBKEY_ADDRESS] = 14;
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1397855816;
        genesis.nNonce = 368133;
        ...
        assert(hashGenesisBlock == uint256("0x000002bf11a6d474477034f7f20535d8253c34dcf03827f12d5810fc22f30896"));

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("testseed1.futurecoin.org", "testseed1.futurecoin.org"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x6d38f4aff8eb0fca93cb362888f2bcc0e54e232b4ea4489bc38e811cdb389266"));
