...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: futurecoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: futurecoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 10901 or testnet: 18333)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10901 or testnet: 18332)") + "\n";
    ...
    strUsage += "  -algo=<algo>           " + _("Mining algorithm: sha256d, groestl, skein") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    else if (strAlgo == "q2c" || strAlgo == "skein")
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Futurecoin is probably already running."), strDataDir.c_str()));
